...
ScriptName AutoLoot:Fragments:Terminals:TERM_AutoLoot_426_Weapons_04001096 Extends Terminal Hidden Const
...
; [ITXT]		Abernathy Farm
; ---------------------------------------------------------------------
GlobalVariable kGlobal = AutoLoot_Globals_Destination.GetAt(16) as GlobalVariable
kGlobal.SetValue(0)
;END CODE
EndFunction
;END FRAGMENT
