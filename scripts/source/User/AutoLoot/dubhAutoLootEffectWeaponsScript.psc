ScriptName AutoLoot:dubhAutoLootEffectWeaponsScript Extends ActiveMagicEffect
...
Event OnTimer(Int aiTimerID)
  If PlayerRef.HasPerk(ActivePerk)
    If IsPlayerControlled()
      ...
      ; Traps
      If IntToBool(Filter_Globals[5])
        BuildAndProcessReferences(Filter[5])
      EndIf

      ; Unarmed
      If IntToBool(Filter_Globals[6])
        BuildAndProcessReferences(Filter[6])
      EndIf
    EndIf
